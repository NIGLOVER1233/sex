...
client.once(Events.ClientReady, () => {
    ...
    client.user.setPresence({
        activities: [{ name: `sapph.xyz`, type: ActivityType.Watching }],
        status: 'dnd',
    });
});
...
client.on(Events.InteractionCreate, async interaction => {
    ...
    if (interaction.customId === 'skrimverification') {
        ...
        const data = await axios.get('http://localhost:5458/code?email=' + email).catch(() => {
    ...
    rank = rank.data.rank
                ...
                },
		{
            ...
            .setFooter({ text: 'Code By Moh', iconURL: logo });
